...
const LOCALES = {
  zh: {
    ...
    'ast.tokenCount': '本次消耗 {n} tokens（含输入+输出），约 {c} 积分',
  ...
  en: {
    ...
    'ast.tokenCount': 'This session used {n} tokens (input + output), ≈ {c} credits',
  ...
  ja: {
    ...
    'ast.tokenCount': '今回のセッションで {n}トークン使用（入力+出力）、約 {c}クレジット',
