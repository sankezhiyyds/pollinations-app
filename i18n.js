...
const LOCALES = {
  zh: {
    ...
    'tool.qMedium': '中（默认）',
    'tool.qLow': '低（文件更小）',
    'tool.webpExtractTip': '（提取单帧，不是动图）',
    'tool.gifFormat': 'GIF（动图）',
    'tool.videoWarn': '视频转码在浏览器本地实时进行，不依赖服务器、无需下载引擎；GIF 会逐帧编码，请保持页面在前台',
  ...
  en: {
    ...
    'tool.videoWarn': 'Transcoding runs locally in your browser in real time — no server, no engine download. GIF is encoded frame by frame, so keep this tab in the foreground.',
  ...
  ja: {
    ...
    'tool.videoWarn': '変換はブラウザ内でリアルタイムに完結しサーバー不要・エンジンのダウンロードも不要。GIF はフレームごとにエンコードするため、タブを前面に保ってください',
